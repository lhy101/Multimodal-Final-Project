...
new_json_train = 'annotations/train.json'
new_json_test = 'annotations/test.json'
new_json_val = 'annotations/val.json'
# new_json_restval = 'annotations/restval.json'
...
def map_format_kaggle_to_clipcap():
    ...
    val_data = []
    restval_data = []
    splits = {'train': train_data, 'test': test_data, 'val': val_data, 'restval': val_data}
    # splits = {'train': train_data, 'test': test_data, 'val': val_data, 'restval': restval_data}
